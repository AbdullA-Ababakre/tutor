...
class Wxml2Canvas {
    ...
    _saveCanvasToImage () {
        ...
        }, self.device.system.indexOf('iOS') === -1 ? 600 : 300);
    }
    ...
    _drawText (item, style, resolve, reject, type, isWxml) {
        ...
        try {
            ...
            this._drawBoxShadow(style.boxShadow, null, item);
    ...
    _drawBoxShadow (boxShadow, callback, item) {
        ...
        if (boxShadow) {
            ...
            this.ctx.setShadow(boxShadow.offsetX, boxShadow.offsetY, boxShadow.blur, boxShadow.color);
            //console.log(item, boxShadow.color, this.width - item.x * 2);
            if (item) {
                this._drawLineToCanvas(item.x, item.y, item.x + this.width - item.x * 2, item.y, {
                    width: 1,
                    stroke: '#eee'
                })
            }
            //console.log(this.ctx.setShadow, boxShadow.color);
        }else {
